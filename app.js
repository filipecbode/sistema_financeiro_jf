...
let suppliers = [
    {"id": 1, "nome": "Companhia Elétrica", "email": "atendimento@energia.com", "telefone": "(11) 0800-123-4567", "endereco": "Av. Energia, 123 - São Paulo/SP", "documento": "12.345.678/0001-90", "status": "ativo"},
    {"id": 2, "nome": "Companhia de Gás", "email": "atendimento@gas.com", "telefone": "(11) 0800-987-6543", "endereco": "Rua do Gás, 456 - São Paulo/SP", "documento": "98.765.432/0001-10", "status": "ativo"},
    {"id": 3, "nome": "NET - Jose Carlos", "email": "josecarlos@net.com", "telefone": "(11) 99999-1111", "endereco": "Av. Internet, 789 - São Paulo/SP", "documento": "11.111.111/0001-11", "status": "ativo"},
    {"id": 4, "nome": "Condomínio IBVS", "email": "admin@condominioibvs.com", "telefone": "(11) 3333-4444", "endereco": "Rua do Condomínio, 100 - São Paulo/SP", "documento": "22.222.222/0001-22", "status": "ativo"},
    {"id": 5, "nome": "Faculdade", "email": "financeiro@faculdade.edu", "telefone": "(11) 5555-6666", "endereco": "Av. Educação, 500 - São Paulo/SP", "documento": "33.333.333/0001-33", "status": "ativo"},
    {"id": 6, "nome": "Banco ITAU", "email": "atendimento@itau.com.br", "telefone": "(11) 4004-4828", "endereco": "Av. Paulista, 1000 - São Paulo/SP", "documento": "60.701.190/0001-04", "status": "ativo"},
    {"id": 7, "nome": "DigiSat", "email": "cobranca@digisat.com", "telefone": "(11) 7777-8888", "endereco": "Rua Tecnologia, 200 - São Paulo/SP", "documento": "44.444.444/0001-44", "status": "ativo"},
    {"id": 8, "nome": "Nubank", "email": "atendimento@nubank.com.br", "telefone": "(11) 0800-608-6068", "endereco": "Rua Nubank, 300 - São Paulo/SP", "documento": "18.236.120/0001-58", "status": "ativo"},
    {"id": 9, "nome": "Servidor Nuvens", "email": "suporte@servidornuvens.com", "telefone": "(11) 9999-0000", "endereco": "Av. Cloud, 400 - São Paulo/SP", "documento": "55.555.555/0001-55", "status": "ativo"},
    {"id": 10, "nome": "Operadora Internet", "email": "suporte@internet.com", "telefone": "(11) 1111-2222", "endereco": "Rua Internet, 600 - São Paulo/SP", "documento": "66.666.666/0001-66", "status": "ativo"},
    {"id": 11, "nome": "Receita Federal", "email": "atendimento@receita.fazenda.gov.br", "telefone": "(11) 146", "endereco": "Av. Tributos, 700 - Brasília/DF", "documento": "00.000.000/0001-91", "status": "ativo"},
    {"id": 12, "nome": "Operadora Celular", "email": "atendimento@celular.com", "telefone": "(11) 2222-3333", "endereco": "Av. Celular, 800 - São Paulo/SP", "documento": "77.777.777/0001-77", "status": "ativo"},
    {"id": 13, "nome": "Cartão Will", "email": "atendimento@will.com.br", "telefone": "(11) 3333-4444", "endereco": "Rua Will, 900 - São Paulo/SP", "documento": "88.888.888/0001-88", "status": "ativo"},
    {"id": 14, "nome": "Banco PAN", "email": "atendimento@bancopan.com.br", "telefone": "(11) 4444-5555", "endereco": "Av. PAN, 1000 - São Paulo/SP", "documento": "99.999.999/0001-99", "status": "ativo"},
    {"id": 15, "nome": "Imobiliária", "email": "vendas@imobiliaria.com", "telefone": "(11) 5555-6666", "endereco": "Rua Imóveis, 1100 - São Paulo/SP", "documento": "10.101.010/0001-01", "status": "ativo"},
    {"id": 16, "nome": "Mercado Pago", "email": "atendimento@mercadopago.com.br", "telefone": "(11) 6666-7777", "endereco": "Av. Mercado, 1200 - São Paulo/SP", "documento": "11.222.333/0001-44", "status": "ativo"},
    {"id": 17, "nome": "Henrique", "email": "henrique@email.com", "telefone": "(11) 88888-9999", "endereco": "Rua do Funcionário, 1300 - São Paulo/SP", "documento": "123.456.789-00", "status": "ativo"}
];
...
function renderTransactions(tipo) {
        ...
        return `
            <div class="transaction-item ${transaction.status} ${isOverdue ? 'overdue' : ''}">
                ...
                <div class="transaction-actions">
                    ...
                    <button class="btn btn--sm btn--secondary" onclick="editTransaction(${transaction.id})">✏️ Editar</button>
                    <button class="btn btn--sm btn--danger" onclick="deleteTransaction(${transaction.id})">🗑️ Excluir</button>
                </div>
            </div>
        `;
    }).join('');
    ...
    console.log(`✅ ${filteredTransactions.length} ${tipo === 'receita' ? 'receitas' : 'despesas'} renderizadas`);
}
...
// === MODAL DE TRANSAÇÃO ===
function openTransactionModal(tipo = 'despesa') {
    ...
    console.log(`📝 Modal aberto para: ${tipo}`);
}
...
function toggleParcelasRestantes() {
    ...
    if (recorrenteCheckbox && parcelasGroup) {
...
function saveTransaction(event) {
    ...
    const transactionData = {
        tipo: 'despesa', // Fixo para esta página
    ...
    if (currentEditingId) {
        ...
        if (index !== -1) {
            ...
            console.log(`✏️ Transação ${currentEditingId} atualizada`);
        }
    } else {
...
function editTransaction(id) {
    ...
    // Definir categoria e fornecedor após popular
    setTimeout(() => {
    ...
    document.getElementById('transaction-modal-title').textContent = 'Editar Conta a Pagar';
...
function deleteTransaction(id) {
    ...
    renderTransactions('despesa');
    console.log(`🗑️ Transação ${id} excluída`);
}
...
function markAsPaid(id) {
    ...
    if (transaction.recorrente) {
        ...
        console.log(`🔄 Próxima recorrência criada: ${nextTransaction.id}`);
        ...
        transactions.push(nextTransaction);
        console.log(`📋 Próxima parcela criada: ${nextTransaction.id}`);
    }
    
    renderTransactions('despesa');
    console.log(`✅ Transação ${id} marcada como paga`);
}
...
function markAsPending(id) {
    ...
    transaction.status = 'pendente';
    renderTransactions('despesa');
    console.log(`⏰ Transação ${id} marcada como pendente`);
}
...
// Log inicial
console.log('🚀 GestãoPro - Sistema Carregado');
